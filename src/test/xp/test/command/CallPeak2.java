...
public class CallPeak2 extends CommandLineProgram{
	static Logger logger = Logger.getLogger(CallPeak2.class.getName());	
    ...
    public static void main(String[] argv){
    	System.exit(new CallPeak2().instanceMain(argv));
