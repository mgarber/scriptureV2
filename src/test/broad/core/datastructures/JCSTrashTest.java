 ...
 *
 */
public class JCSTrashTest
    extends TestCase
{

    private static final Log LOG = LogFactory.getLog( JCSTrashTest.class.getName() );
    ...
    {
        junit.textui.TestRunner.run( JCSTrashTest.class );
    }

    /**
     * @param arg0
     */
    public JCSTrashTest( String arg0 )
    {
        super( arg0 );
    }
        ...
        throws Exception
    {
        ...
        for ( int i = 0; i < 15; i++ )
        {
            final JCSTrashTest.Executable executable = new JCSTrashTest.Executable()
            {
                public void execute()
                    throws Exception
                {
        ...
        throws Exception
    {
        ...
        {
            final JCSTrashTest.Executable executable = (JCSTrashTest.Executable) executables.get( i );
